...
const fixedCardClass =
  "h-[520px] overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 p-5 shadow-xl shadow-slate-200/60 backdrop-blur-xl dark:border-white/[0.08] dark:bg-[#0f0c1f]/90 dark:shadow-black/25 sm:p-6";
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-950 dark:bg-[#09090f] dark:text-white">
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] space-y-5 px-4 py-5 sm:px-6 lg:px-8 xl:px-10">
          ...
          <div className={fixedCardClass}>
            <div className="flex h-full flex-col">
              <SectionHeader
                ...
                description="Add or update a balance source. Saved records are managed in the balance records section below."
              />
        ...
        <section
          ref={expenseFormRef}
          className="h-[520px] overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 p-5 shadow-xl shadow-slate-200/60 backdrop-blur-xl dark:border-white/[0.08] dark:bg-[#0f0c1f]/90 dark:shadow-black/25 sm:p-6"
        >
          <div className="flex h-full flex-col">
            <div className="mb-5 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <SectionHeader
        ...
        <section className="grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
          <div className="h-[640px] overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/90 p-5 shadow-xl shadow-slate-200/60 backdrop-blur-xl dark:border-white/[0.08] dark:bg-[#0f0c1f]/90 dark:shadow-black/25 sm:p-6">
            <div className="flex h-full flex-col">
              ...
              <div className="flex-1 overflow-hidden rounded-3xl border border-slate-200 dark:border-white/[0.08]">
          ...
          <div className="grid h-[640px] gap-5">
            <div className={`${cardClass} overflow-hidden`}>
              <div className="flex h-full flex-col">
                ...
                <div className="mt-5 min-h-0 flex-1 rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-slate-100 p-4 dark:border-white/[0.08] dark:from-white/[0.04] dark:to-white/[0.02]">
                  {chartData.length > 0 ? (
