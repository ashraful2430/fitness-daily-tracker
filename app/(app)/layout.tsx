...
export default function AppLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="relative min-h-dvh bg-[#f3ede1] text-slate-900 dark:bg-[#070912] dark:text-white lg:flex lg:h-dvh lg:overflow-hidden">
      ...
      <div className="relative z-10 min-w-0 flex-1 overflow-x-clip pb-[env(safe-area-inset-bottom)] lg:h-dvh lg:overflow-x-hidden lg:overflow-y-auto">
